                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>()
                    {
                        new Movie()
                        {
                            ...
                            CinemaId = 3,
                            ProducerId = 3,
                            MovieCatergory = MovieCatergory.Documentary
                        },
                        new Movie()
                        {
                            ...
                            CinemaId = 1,
                            ProducerId = 1,
                            MovieCatergory = MovieCatergory.Action
                        },
                        new Movie()
                        {
                            Name = "Ghost",
                            ...
                            CinemaId = 4,
                            ProducerId = 4,
                            MovieCatergory = MovieCatergory.Horror
                        },
                        new Movie()
                        {
                            Name = "Race",
                        ...
                        new Movie()
                        {
                            ...
                            CinemaId = 1,
                            ProducerId = 3,
                            MovieCatergory = MovieCatergory.Cartoon
                        },
                        new Movie()
                        {
                            Name = "Cold Soles",
